...
from util.logging_helpers import plot_tensors_hist
from util.logging_helpers import plot_index
#from model.pix2pix_model import Pix2PixModel
#from model.base_model import BaseModel
from model import networks
from util.losses import ssim_loss
from util.losses import emd_loss as hist_loss
import gc
...
class Px2Px_PL(pl.LightningModule):
    def __init__(self, opt):
        ...
        if self.config.base_configs.lambda_rs_losses>0.0:
            from util.remote_sensing_indices import RemoteSensingIndices
